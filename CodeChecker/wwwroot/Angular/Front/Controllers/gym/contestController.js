(function() {
    ...
    angular.module("app-gym")
        .controller("gymController", function (NgTableParams, $http, $resource, $scope, toastr, $uibModal, $uibModalStack) {
            var apiUrl = "/api/front/gym/all";
            var _self = this;
            ...
            $scope.joinContest = function(contest,isPublic) {
                ...
                var attendContest = function(password) {
                    ...
                    $http.post("/api/front/gym/join", contestData)
